...
for(z=x.length,v=0;v<y;++v){u=v*w
t=C.CD.yu(Math.floor(u))
for(s=0,r=0;r<w;++r){q=t+r
if(q<0||q>=z)return H.e(x,q)
s+=x[q]}s/=w
if(s>0)s+=s*0.5
if(u<0||u>=z)return H.e(x,u)
u=$.Pk
J.yc(u,"hsl( 240, 100%, 50%)")
u.fillRect(v*3,window.innerHeight,1,-s)}z=window
C.ol.hr(z)
...
"%":"AudioContext|OfflineAudioContext|webkitAudioContext"}}],["dart.typed_data","dart:typed_data",,P,{
"":"",
HY:{
"":"Gv;",
