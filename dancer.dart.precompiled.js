...
VX:{
"":"Tp:12;c",
call$1:function(a){return this.c(a)}}}],["","dancer.dart",,O,{
"":"",
...
for(z=x.length,v=0,u=0;u<y;++u){t=u*w
s=C.CD.yu(Math.floor(t))
for(r=0,q=0;q<w;++q){p=s+q
if(p<0||p>=z)return H.e(x,p)
r+=x[p]}r/=w
v+=r
if(r>0)r+=r*1.5
if(t<0||t>=z)return H.e(x,t)
J.yc($.Pk,"rgba("+$.iP()+",.75)")
J.HM($.Pk,u*3,window.innerHeight,1,-r)}z=$.eI
if(z==null)$.eI=a
else if(J.xZ(J.xH(a,z),450)){$.eI=a
v/=y
$.pf=document.querySelector("h1")
z=$.It()
t=$.pB().j1(7)
if(t<0||t>=7)return H.e(z,t)
$.ih=z[t]
if(v<40){J.FI($.pf.style,"rgba(255,255,255,.65)")
o="Turn the music back on"}else if(v<100){n=$.It()[0]
J.FI($.pf.style,"rgba("+n+",.65)")
o="Aite now we bumpin'"}else if(v<150){n=$.It()[1]
J.FI($.pf.style,"rgba("+n+", .65)")
o="Yeah let's fucking rage"}else{n=$.It()[1]
J.FI($.pf.style,"rgba("+n+", .65)")
o="JAKE JAKE JAKE JAKE JAKE"}$.pf.textContent=o}z=window
C.ol.hr(z)
...
I.$lazy($,"color","ih","iP",function(){var z,y
z=$.It()
y=$.pB().j1(7)
