...
init.globalState.Xz.Rk.NZ(new H.IY(q,new H.bL(w,v,u,t,s),"worker-start"))
...
VX:{
"":"Tp:12;c",
call$1:function(a){return this.c(a)}}}],["","file:///Users/fouad/git/fouad/dancer/web/dancer.dart",,O,{
"":"",
...
y=C.CD.yu(C.jn.UD(z/3))
x=new Uint8Array($.VK.frequencyBinCount)
...
if(typeof z!=="number")return z.V()
w=C.CD.yu(Math.floor(z/y))
z=$.It()
v=$.pB().j1(7)
if(v<0||v>=7)return H.e(z,v)
u=z[v]
for(z=x.length,t=0,s=0;s<y;++s){v=s*w
r=C.CD.yu(Math.floor(v))
for(q=0,p=0;p<w;++p){o=r+p
if(o<0||o>=z)return H.e(x,o)
q+=x[o]}q/=w
t+=q
if(q>0)q+=q*1.5
if(v<0||v>=z)return H.e(x,v)
v=$.Pk
J.yc(v,"rgba("+u+",.75)")
v.fillRect(s*3,window.innerHeight,1,-q)}z=$.eI
if(z==null)$.eI=a
else if(J.xZ(J.xH(a,z),450)){$.eI=a
t/=y
P.JS(t)
z=document.querySelector("h1")
$.pf=z
if(t<40){J.FI(z.style,"rgba(255,255,255,.65)")
n="Turn the music back on"}else if(t<100){u=$.It()[0]
J.FI(z.style,"rgba("+u+",.65)")
n="Aite now we bumpin'"}else if(t<150){u=$.It()[1]
J.FI(z.style,"rgba("+u+", .65)")
n="Yeah let's fucking rage"}else{u=$.It()[1]
J.FI(z.style,"rgba("+u+", .65)")
n="JAKE JAKE JAKE JAKE JAKE"}$.pf.textContent=n}z=window
C.ol.hr(z)
C.ol.oB(z,W.VF(O.XH()))},"call$1","XH",2,0,0],
oF:[function(a){var z
$.tQ=J.Sp($.rS())
...
z=window
C.ol.hr(z)
C.ol.oB(z,W.VF(O.XH()))},"call$1","ID",2,0,0],
Iq:[function(){var z=document.querySelector("#dancer")
$.qN=z
$.Pk=J.PB(z,"2d")
J.Uv(window.navigator,!0).ml(O.ID())},"call$0","eE",0,0,1]},1],["dart._collection.dev","dart:_collection-dev",,H,{
"":"",
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"IW","call$2","call$1","gaq",2,2,2,3],
...
$isa6:true,
static:{"":"Wt,S4,dk,Lo,zj,b2,q9,Ie,Do,Cv,kT,IJ,V6,Vk,S8,yn",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"":"Tp:16;",
...
z=this.b.MM
if(z.Gv!==0)H.vh(P.w("Future already completed"))
z.CG(a,null)}}}],["dart.dom.web_audio","dart:web_audio",,P,{
"":"",
WK:{
"":"D0;",
mH:function(a){if(a.createGain!==undefined)return a.createGain()
else return a.createGainNode()},
"%":"AudioContext|OfflineAudioContext|webkitAudioContext"}}],["dart.math","dart:math",,P,{
"":"",
mg:{
"":"a;",
...
HY:{
"":"Gv;",
vf:function(a,b,c){var z=J.Wx(b)
...
if(b>>>0!=b||J.J5(b,z))this.vf(a,b,z)
a[b]=c},
"%":";Uint8Array"},
ue:{
"":"HY;",
...
init.metadata=[{func:"G5",void:true,args:[null]},{func:"X0",void:true},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"ZH",args:[J.im]},{func:"iR",args:[J.im,null]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
ib.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,oJ,DG,HA,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,Gx,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,r0,nK,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,U1,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,fv,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,UM,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,VN,WK,p2,vN,rO,xl,XN,Jm,cX,Xr,Gn,Sl,Jo,Qm,HY,n6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,bL,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,SU,Ca,b8,Pf,Zf,vs,da,xw,dm,rH,ZL,mi,jb,wB,Pu,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,BV,id,Lx,QM,mg,ue,iY,C0,Rd,aI,rG,yh,wO,Tk,ib]}