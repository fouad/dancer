...
"%":"AudioParam|CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"},
kn:{
"^":"Gv;",
...
VX:{
"^":"d9:11;c",
$1:function(a){return this.c(a)}}}],["","file:///Users/fouad/git/fouad/dancer/web/dancer.dart",,O,{
"^":"",
G4:[function(b2){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1
if(J.xC($.t5,"alert")){z=$.jU
y=$.Pk
if(z)J.yc(y,"#4994B6")
else J.yc(y,"#FC0C4C")
$.jU=!$.jU
J.HM($.Pk,0,0,window.innerWidth,window.innerHeight)
P.rT(C.Hk,new O.ZM())
$.pf.textContent="QUIET QUIET QUIET"
return}z=$.Pk
z.canvas.width=window.innerWidth
z.canvas.height=window.innerHeight
z=$.VK.frequencyBinCount
if(typeof z!=="number"||Math.floor(z)!==z)H.vh(P.u("Invalid length "+H.d(z)))
x=new Uint8Array(z)
$.VK.getByteFrequencyData(x)
z=$.It()
y=$.pB().j1(7)
if(y<0||y>=7)return H.e(z,y)
w=z[y]
if(J.xC($.t5,"bars")||J.xC($.t5,"circles")){z=window.innerWidth
if(typeof z!=="number")return z.V()
v=C.CD.yu(C.jn.UD(z/3))
J.Eu($.Pk,0,0,window.innerWidth,window.innerHeight)
J.yc($.Pk,"#F6D565")
J.LM($.Pk,"round")
z=$.VK.frequencyBinCount
if(typeof z!=="number")return z.V()
u=C.CD.yu(Math.floor(z/v))
for(z=x.length,t=0,s=0;s<v;++s){y=s*u
r=C.CD.yu(Math.floor(y))
for(q=0,p=0;p<u;++p){o=r+p
if(o<0||o>=z)return H.e(x,o)
q+=x[o]}q/=u
t+=q
if(q>0)q+=q*1.5
if(y<0||y>=z)return H.e(x,y)
J.yc($.Pk,"rgba("+w+",.75)")
if(J.xC($.t5,"bars"))J.HM($.Pk,s*3,window.innerHeight,1,-q)
else{y=$.pB()
o=window.innerWidth
...
J.lJ(y,10+o,n-s*1.8,C.CD.yu(C.CD.UD(q/15)),0,6.283185307179586,!0)
J.Mq($.Pk)
J.Wm($.Pk)}}t=0
v=null}else{if(J.xC($.t5,"circlegrid")){v=64
m=8}else{if(J.xC($.t5,"nucleus"))v=256
else v=J.xC($.t5,"grid")?32:16
m=null}if(J.xC($.t5,"mind")||J.xC($.t5,"spiralcircle"))J.SK($.Pk,5)
J.Eu($.Pk,0,0,window.innerWidth,window.innerHeight)
J.yc($.Pk,"#F6D565")
J.LM($.Pk,"round")
z=$.VK.frequencyBinCount
...
u=C.CD.yu(Math.floor(z/v))
z=x.length
x=new Uint8Array(x.subarray(0,C.NA.PZ(x,0,C.CD.yu(Math.floor(z/2)),z)))
for(z=x.length,y=z/v,o=z/2,t=0,s=0;s<z;s+=C.CD.yu(Math.floor(y))){J.yc($.Pk,"rgba("+w+",.75)")
J.bs($.Pk,"rgba("+w+",.75)")
for(q=0,p=0;p<y;++p){n=s+p
if(n<0||n>=z)return H.e(x,n)
q+=x[n]}q/=u
t+=q
if(J.xC($.t5,"circlegrid")){J.Dg($.Pk)
n=q/2
l=C.CD.yu(C.jn.UD($.pB().j1(C.CD.yu(C.jn.UD(q))+1)-n))
k=C.CD.yu(C.jn.UD($.pB().j1(C.CD.yu(C.jn.UD(q))+1)-n))
j=s/y
...
c=$.Pk
b=Math.log(s+1)
J.lJ(c,i*h/m+g/m/2+l/2,f-j*e/m+d/m/2+k/2,C.CD.yu(C.CD.UD(n*b/Math.log(10))),0,6.283185307179586,!0)
J.Mq($.Pk)
J.Wm($.Pk)}else if(J.xC($.t5,"nucleus")){n=window.innerWidth
if(typeof n!=="number")return n.V()
a=C.CD.yu(C.jn.UD(n/2))
n=window.innerHeight
if(typeof n!=="number")return n.V()
a0=C.CD.yu(C.jn.UD(n/2))
J.zc($.Pk,a,a0)
n=s+1
a1=360*(n/z)
a2=a+Math.cos(a1)*q*4
a3=a0+Math.sin(a1)*q*4
J.IL($.Pk,a2,a3)
J.cM($.Pk)
J.Dg($.Pk)
l=$.Pk
n=Math.log(n)
J.lJ(l,a2,a3,C.CD.yu(C.CD.UD(q/10*n/Math.log(10))),0,6.283185307179586,!0)
J.Mq($.Pk)
J.cM($.Pk)}else if(J.xC($.t5,"spiralcircle")){n=$.pB().j1(10)
l=$.pB().j1(10)
J.Dg($.Pk)
k=$.Pk
j=window.innerWidth
...
J.lJ(k,j/2+(n-5),i/2+(l-5),q*5,0,6.283185307179586,!0)
J.Mq($.Pk)
J.cM($.Pk)}else if(J.xC($.t5,"mind")){n=$.pB().j1(50)
l=$.pB().j1(50)
J.Dg($.Pk)
k=$.Pk
j=window.innerWidth
...
i=window.innerHeight
if(typeof i!=="number")return i.V()
J.lJ(k,j/2+(n-25),i/2+(l-25),200+q*2,0,6.283185307179586,!0)
J.Mq($.Pk)
J.cM($.Pk)}else if(J.xC($.t5,"grid")){a4=window.innerWidth
...
n=window.innerHeight
if(typeof n!=="number")return n.W()
J.IL(l,a4,n-a6)}else{J.zc(n,a6,0)
J.IL($.Pk,a6,a5)
n=$.Pk
l=window.innerWidth
if(typeof l!=="number")return l.W()
...
n=window.innerWidth
if(typeof n!=="number")return n.W()
J.IL(l,n-a6,a5)}J.cM($.Pk)}else{n=$.Pk
if(s>o){l=window.innerHeight
...
a3=k/2
J.EM($.Pk,a7,a8,a9,b0,a2,a3)
J.zc($.Pk,0,a0)
J.EM($.Pk,a7,b0,a9,a8,a2,a3)}else{l=window.innerWidth
if(typeof l!=="number")return l.V()
a=l/2
l=window.innerHeight
if(typeof l!=="number")return l.V()
...
J.EM($.Pk,a7,a8,a9,b0,a2,a3)
J.zc($.Pk,a,a0)
J.EM($.Pk,a9,a8,a7,b0,a2,a3)}J.cM($.Pk)}}}z=$.eI
if(z==null)$.eI=b2
else if(J.xZ(J.xH(b2,z),450)){$.eI=b2
if(v==null)v=1
if(typeof v!=="number")return H.s(v)
t/=v
z=document.querySelector("h1")
$.pf=z
if(t<40){J.FI(z.style,"rgba(255,255,255,.65)")
b1="Turn the music back on"}else if(t<100){w=$.It()[0]
J.FI(z.style,"rgba("+w+",.65)")
b1="Aite now we bumpin'"}else if(t<150){w=$.It()[1]
J.FI(z.style,"rgba("+w+", .65)")
b1="Yeah let's fucking rage"}else{w=$.It()[1]
J.FI(z.style,"rgba("+w+", .65)")
b1="OH SHIT DAWG"}$.pf.textContent=b1}z=window
C.ol.hr(z)
C.ol.oB(z,W.VF(O.XH()))},"$1","XH",2,0,0],
KI:function(){var z=W.pS("ws://"+$.L3+"/ws",null)
$.Wz=z
z=H.VM(new W.RO(z,C.Mp.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new O.fX()),z.Sg),[H.Kp(z,0)]).Zz()
z=$.Wz
z.toString
z=H.VM(new W.RO(z,C.i6.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new O.Tp()),z.Sg),[H.Kp(z,0)]).Zz()
z=$.Wz
z.toString
z=H.VM(new W.RO(z,C.MD.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new O.v3()),z.Sg),[H.Kp(z,0)]).Zz()
z=$.Wz
z.toString
z=H.VM(new W.RO(z,C.ph.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new O.zI()),z.Sg),[H.Kp(z,0)]).Zz()},
oF:[function(a){var z
$.tQ=J.Sp($.rS())
z=$.rS().createMediaStreamSource(a)
$.fd=z
$.xn=z
z.connect($.tQ,0,0)
z=$.rS().createAnalyser()
...
z.gain.value=0
$.tQ.connect(z,0,0)
$.wP.connect($.rS().destination,0,0)
z=window
C.ol.hr(z)
C.ol.oB(z,W.VF(O.XH()))},"$1","ID",2,0,0],
Iq:[function(){var z=document.querySelector("#dancer")
$.qN=z
$.Pk=J.PB(z,"2d")
O.KI()
J.Uv(window.navigator,!0).ml(O.ID())},"$0","eE",0,0,1],
ZM:{
"^":"d9:7;",
$0:function(){O.G4(0)}},
fX:{
...
Tp:{
"^":"d9:9;",
$1:function(a){P.JS("Websocket closed")}},
v3:{
"^":"d9:9;",
...
$.t5=z.gRn(a)
P.JS("Received message: "+H.d(z.gRn(a)))}}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
try{y=d.$2(e,f)
return y}finally{$.X3=z}},
ZK:function(a,b,c,d){P.IA(C.NU!==c?c.ce(d):d)},
...
z.toString
P.ZK(z,null,z,new P.da(this,a))}else{a.BQ=this.jk
this.jk=a}},
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"QC","$2","$1","gbY",2,2,13,14],
OH:function(a){var z
...
z=this.Lj
z.toString
P.ZK(z,null,z,new P.rH(this,a))}else P.A9(a,this)}else P.k3(a,this)
return}}if(this.Gv!==0)H.vh(P.w("Future already completed"))
this.Gv=1
z=this.Lj
z.toString
P.ZK(z,null,z,new P.cX(this,a))},
...
$isvs:true,
$isb8:true,
static:{"^":"e3,Ry,cp,Cd,NK",Dt:function(a){return H.VM(new P.vs(0,$.X3,null,null,null,null,null,null),[a])},k3:function(a,b){b.Gv=2
...
$isiP:true,
static:{"^":"aV,Vp,Ej,yz,ch,QC,Px,Yp,kc,Gi,Fz,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
"%":"AnalyserNode|AudioDestinationNode|AudioGainNode|AudioNode|AudioSourceNode|GainNode|MediaStreamAudioSourceNode|RealtimeAnalyserNode;EventTarget"},
dU:{
"^":"Az;",
$isdU:true,
"%":"File"},
...
"^":"d9:9;b",
$1:function(a){var z
if(a==null)H.vh(P.u("Error must not be null"))
z=this.b.MM
if(z.Gv!==0)H.vh(P.w("Future already completed"))
z.CG(a,null)}},
I2:{
...
if(z!=null)J.GJ(this.uv,this.Ph,z,this.Sg)}}}],["dart.dom.web_audio","dart:web_audio",,P,{
"^":"",
WK:{
"^":"D0;",
mH:function(a){if(a.createGain!==undefined)return a.createGain()
else return a.createGainNode()},
"%":"AudioContext|OfflineAudioContext|webkitAudioContext"}}],["dart.isolate","dart:isolate",,P,{
"^":"",
IU:{
"^":"a;",
$isIU:true,
...
I.$lazy($,"audioContext","VB","rS",function(){return new (window.AudioContext||window.webkitAudioContext)()})
I.$lazy($,"colors","MY","It",function(){return["36, 179, 96","204, 51, 51","44,133,211","156,0,233","151,207,58","250,105,0","60,87,118"]})
...
init.metadata=[{func:"G5",void:true,args:[null]},{func:"X0",void:true},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"ec",args:[W.cx]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"ZH",args:[P.KN]},{func:"iR",args:[P.KN,null]},];$=null
